            ...
            <CardContent>
              <Tabs defaultValue="overview">
                <TabsList className="grid w-full grid-cols-3">
                  ...
                  <TabsTrigger value="history" className="inline-flex items-center after:hidden data-[state=active]:after:inline-block data-[state=active]:after:bg-foreground after:ml-2 after:h-1.5 after:w-1.5 after:rounded-full">활동</TabsTrigger>
                </TabsList>
