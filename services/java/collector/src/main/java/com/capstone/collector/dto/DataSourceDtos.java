...
public class DataSourceDtos {
    ...
    public record DataSource(Long id, String name, String url, String source_type, Boolean is_active, OffsetDateTime last_collected, Integer collection_frequency, Map<String, Object> metadata_json, OffsetDateTime created_at, OffsetDateTime updated_at) {}
}